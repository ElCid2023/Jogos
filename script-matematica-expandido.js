class ExpandedMathGame {
    ...
    bindEvents() {
        ...
        // Modos de jogo (serão adicionados dinamicamente baseado na idade)
        ...
        // Botões de revisão
        document.getElementById('review-btn-intermediate')?.addEventListener('click', () => {
            this.showReview('intermediate');
        });
        
        document.getElementById('review-btn-advanced')?.addEventListener('click', () => {
