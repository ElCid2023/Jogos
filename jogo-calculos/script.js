class CalculusGame {
    constructor() {
        this.studentName = localStorage.getItem('studentName') || 'Estudante';
    ...
    playWelcomeSound() {
        if ('speechSynthesis' in window) {
            setTimeout(() => {
                ...
                utterance.text = `Olá ${this.studentName}! Bem-vindos ao jogo de cálculos avançados! Vamos começar com operações básicas.`;
